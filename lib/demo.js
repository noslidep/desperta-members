...
export const demoPrograms=[
 {id:'11111111-1111-1111-1111-111111111111',slug:'formula-gestao-vendas',title:'Fórmula Gestão & Vendas',subtitle:'A fórmula que transforma gestão em lucro.',description:'Um programa prático para fortalecer gestão, posicionamento e processo comercial.',cover_url:'/formula-gestao-vendas.png',status:'published',progress:32,total_lessons:12,completed_lessons:4,enrolled:true},
 {id:'22222222-2222-2222-2222-222222222222',slug:'conexao-vendas',title:'Conexão & Vendas',subtitle:'Relacionamento que gera vendas.',description:'Aprenda a construir conexão, conversas e oportunidades com mais intenção.',cover_url:null,status:'coming_soon',progress:0,total_lessons:0,completed_lessons:0,enrolled:true},
 {id:'33333333-3333-3333-3333-333333333333',slug:'mentoria-cad',title:'Mentoria CAD',subtitle:'Crescimento, Ação e Direção.',description:'Acompanhamento estratégico para transformar decisão em execução.',cover_url:null,status:'locked',progress:0,total_lessons:0,completed_lessons:0,enrolled:false}
]
