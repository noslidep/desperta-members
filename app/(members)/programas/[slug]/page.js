...
export default async function Program({ params }) {
  ...
  return <div className="page">
    <section className="course-hero">
      <div>
        <span className="eyebrow">{type.label}</span>
        <h2>{program.title}</h2>
      ...
      <div className="course-logo"><Image src={program.cover_url || '/formula-gestao-vendas.png'} width={420} height={300} alt={program.title} /></div>
    </section>
